        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          <div className="lg:col-span-5">
            <SectionHeading
              ...
              description="Talk to verified doctors from anywhere in Bangladesh — fast booking, transparent fees, and secure support."
              align="left"
            />
            <SectionParagraph className="mt-3">
              Get expert advice for common health concerns, prescription follow‑ups,
              and guidance before ordering medicines. Online consultations are
              available every day with flexible time slots.
            </SectionParagraph>
              ...
              <div className="relative">
                <div className="flex items-center gap-3">
                  <div className="w-11 h-11 rounded-xl bg-white/15 flex items-center justify-center border border-white/10">
                    <Icons.Heartbeat className="!w-6 !h-6 text-white" />
                  </div>
                  <div>
                    ...
                    <p className="text-xs text-white/70">
                      Fancy, fast and reliable consultancy
                    </p>
                  </div>
                </div>
                  ...
                  {[
                    {
                      ...
                      desc: "Trusted specialists with patient reviews.",
                      Icon: Icons.Shield,
                    },
                    {
                      title: "Quick booking",
                      desc: "Pick a slot and get confirmed by phone.",
                      Icon: Icons.Clock,
                    },
                    {
                      title: "Transparent fees",
                      desc: "Know the consultation fee upfront.",
                      Icon: Icons.Star,
                    },
                    {
                      title: "Safe guidance",
                      desc: "Get help ordering the right medicines.",
                      Icon: Icons.Pill,
                    },
                  ].map(({ title, desc, Icon }) => (
                    <div
                ...
                <div className="mt-6 flex flex-col sm:flex-row gap-2.5">
                  <a href="#doctors" className="sm:flex-1">
                    <CustomButton
                      variant="secondary"
                      size="md"
                      radius="xs"
                  ...
                  <a href="/prescription/upload" className="sm:flex-1">
                    <CustomButton
                      variant="outline"
                      size="md"
                      radius="xs"
                ...
                {[
                  {
                    ...
                    desc: "Filter by specialty, location and online availability.",
                    Icon: Icons.Search,
                  },
                  {
                    title: "Send a request",
                    desc: "Share your name, phone and symptoms to confirm a slot.",
                    Icon: Icons.Mail,
                  },
                  {
                    title: "Get guidance",
                    desc: "Receive advice and safe ordering support from Medigo.",
                    Icon: Icons.Check,
                  },
                ].map(({ title, desc, Icon }) => (
                  <div
                    key={title}
                    className="rounded-xl border border-gray-100 bg-light p-4 flex items-start gap-3"
                  >
          ...
          <div className="lg:col-span-7" id="doctors">
